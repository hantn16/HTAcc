...
using TestApp.Main.Properties;
using TestApp.Main.ViewModels;
using TestApp.Main.Views;
using TestApp.Modules.ViewModels;
using TestApp.Modules.Views;
using AppModules = TestApp.Common.Modules;
